					...
					<div class="content-wrap">
						...
						<section id="tab2">
							...
							<div id= "calc_fecha"  style="display: none;">
									<p class="fecha_tasa"><?php echo 'Usted ha consultado el calculo del monto a pagar en moneda local: '.$fecha_tasa ?></p>
...
{{--									<!--<th scope="row" style="color: #2096c5;"><?php echo e($factura->fac_num); ?></th>-->--}}
									...
									<?php endif; ?>
										...
										<?php echo e(number_format($factura->monto,2)." ");?>$
											...
											<?php if($factura->bal != '0'): ?>
												(<?php echo number_format( ((float)$precio_plan_dl * (float)$tasa),2); ?> Bs.S )
												<!--
									...
									<td>
										...
										(<?php echo number_format( ((float)$monto_rest * (float)$tasa),2); ?> BS.S)
									</td>
						...
						<tr id="element-<?php echo e($factura->id);?>" style="display: none;">
									...
									<td class="monto" >
										<span ><?php echo number_format( ((float)$precio_plan_dl * (float)$tasa),2); ?> BS.S </span>
										<button id="ocultar-<?php echo e($factura->id);?>" class="ocultar calc" title="volver a mostrar monto en $ " type="submit">
											<i class="fas fa-calculator"></i>
										</button>

									</td>  <!-- se reflejara el monto del plan en dolares -->
									<td class="monto" ><?php echo number_format( ((float)$pagado_dl * (float)$tasa),2); ?> BS.S</td>

									<td class="monto" ><?php echo number_format( ((float)$monto_rest * (float)$tasa),2); ?> BS.S</td>
					...
					<div class="four-tab-r">
						<div style="width: 100%; text-align: center;">
							<?php if(round($balanceoD,2) != 0): ?>
							<span style="color:red">Su deuda total es de: <?php echo e(number_format($balanceoD, 2,',', '.')." "); ?> $</span>
							<?php elseif(round($balanceoD,2) == 0 && round($afavord,2) > 0): ?>
							<span style="color:green">Usted tiene un saldo a favor de: <?php echo e(number_format($afavord, 2,',', '.')." "); ?> $</span>
							<?php elseif(round($balanceoD,2) == 0 && round($afavord,2) == 0): ?>
							<span style="color:green">Usted se encuentra solvente</span>
							<?php endif; ?>
						</div>
