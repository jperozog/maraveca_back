    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            ...
            <main>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    @foreach($productos as $producto)
                        <tr>
                            ...
                            @if($cliente->serie == '0')
                                <td class="qty">
                                    {{number_format($producto->precio_dl/$producto->cantidad)}} $
                                </td>
                            @endif
                    ...
                    <tr>
                        ...
                        <td style="color: #2096c5;border-top: 1px solid #2096c5;font-family: montserrat;">{{$producto->precio_dl}} $</td>
                    </tr>
                    </tfoot>
                </table>
                ...
                A solo efectos de lo previsto en el Art.25 de la Ley de Impuesto al Agregado se expresan los montos de la factura en Bolivares(Bs.S) considerando la Tasa de Cambio Promedio de Bs/Dólares de {{number_format($factura->tasa_pago)}} Bs.S
                <div class="montos">
                TOTAL: {{number_format($producto->precio_dl/$producto->cantidad * $factura->tasa_pago)}}  Bs.S
                <br>
                SUBTOTAL: {{number_format($producto->precio_dl/$producto->cantidad * $factura->tasa_pago)}}  Bs.S
                </div>
                </div>
                @endif
                @if(count($pagosfac)>0)
