						...
						<section id="tab2">
							<table class="table table-sm">
								...
								<tr>
									...
									<?php endif; ?>
									<td><?php echo e(number_format($factura->monto,2)." "); ?>Bs.S.</td>
									<td><?php echo e(number_format($factura->pagado,2)." "); ?>Bs.S.</td>
									...
									<div class="panel-body">
										<div class="tab-content">
											<div class="tab-pane fade in active" id="tab1primary">
												<form method="POST" action="<?php echo e(route('reportarpago_juridicos')); ?>">
													...
													<div class="wrap-input100">
														...
														<select class="input100" id="baltip" type="select" class="form-control" name="baltip" required autofocus>
															...
															<option value="6">Bicentanario</option>
