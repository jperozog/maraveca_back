...
//use App\Helpers;
class mensajesmorosos extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'MensajesAMorosos';
    ...
    public function handle()
    {
        //selecciono todos los clientes
          ...
          foreach ($cli as $moroso) {
              if ($moroso->serie == 0 ) {
                            //si el cliente paga en dolares
                  $txt = "actualmente presenta un saldo de: " . number_format($moroso->deuda, 2) . " US$, reporte su pago a traves de: info@maraveca.com, http://maraveca.com/mi-ventana, si ya reportó su pago, haga caso omiso a este mensaje";

              } else{
                            //si el cliente paga en bolivares
                  $txt="actualmente presenta un saldo de: ".number_format($moroso->deuda, 2)." Bs.S, reporte su pago a traves de: info@maraveca.com, http://maraveca.com/mi-ventana, si ya reportó su pago, haga caso omiso a este mensaje";
